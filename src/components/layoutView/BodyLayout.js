  ...
  return (
    <div className='content-body-layout-view'>
      ...
      <div className='view-type-button'>
        <button className='view-btns-icon'><img className="reviewer-avatar-icon" src="./assets/options.svg" alt="Reviewer" /></button>
        <button className='view-btns-icon'><img className="reviewer-avatar-icon" src="./assets/filtering.svg" alt="Reviewer" /></button>
