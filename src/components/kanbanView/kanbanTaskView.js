...
function KanbanTaskView() {
    ...
    return (
        <>
            <div className={`accordion-title ${openTask ? '' : 'closed-accordion'}`} onClick={onAccordionBtnClick}>All Tasks {openTask ? <img className="reviewer-avatar" src="./assets/downArrow.svg" alt="Reviewer" /> : <img className="reviewer-avatar" src="./assets/rightArrow.svg" alt="Reviewer" />}</div>
            {openTask ? (<div className="Kanban-main-container">
